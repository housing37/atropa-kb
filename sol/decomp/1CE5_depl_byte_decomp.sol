...
function approve(address varg0, uint256 varg1) public payable {
    ...
    require(varg0 == varg0);
    require(varg1 == varg1);
    0x970(varg1, varg0, msg.sender);
    return bool(1);
}

function 0x1564(uint256 varg0) private {
    v0 = v1 = varg0 >> 1;
    if (!(varg0 & 0x1)) {
        v0 = v2 = v1 & 0x7f;
    }
...
function transferFrom(address varg0, address varg1, uint256 varg2) public payable {
    ...
    require(varg1 == varg1);
    require(varg2 == varg2);
    0xb33(varg2, msg.sender, varg0);
    0xbbe(varg2, varg1, varg0);
    return bool(1);
}
...
function burn(uint256 varg0) public payable {
    ...
    require(varg0 == varg0);
    0xe33(varg0, msg.sender);
}

function 0x5b19ec68() public payable {
    v0 = _SafeExp(10, uint8(18), uint256.max);
    require(!0x423a35c7 | (v0 == 0x423a35c7 * v0 / 0x423a35c7), Panic(17)); // arithmetic overflow or underflow
    require(0x7a20189b297343cf26d8548764b04891f37f3414, Error('ERC20: mint to the zero address'));
    v1 = _SafeAdd(_totalSupply, 0x423a35c7 * v0);
    _totalSupply = v1;
    v2 = _SafeAdd(_balanceOf[address(0x7a20189b297343cf26d8548764b04891f37f3414)], 0x423a35c7 * v0);
    _balanceOf[address(0x7a20189b297343cf26d8548764b04891f37f3414)] = v2;
    emit Transfer(address(0x0), address(0x7a20189b297343cf26d8548764b04891f37f3414), 0x423a35c7 * v0);
}
...
function decreaseAllowance(address varg0, uint256 varg1) public payable {
    ...
    0x970(_allowance[msg.sender][varg0] - varg1, varg0, msg.sender);
    return bool(1);
}
...
function 0x35b() private {
    v0 = 0x1564(array_3.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1564(array_3.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_3.data;
...
function 0x65b() private {
    v0 = 0x1564(array_4.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1564(array_4.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_4.data;
...
function 0x970(uint256 varg0, address varg1, address varg2) private {
...
function 0xb33(uint256 varg0, uint256 varg1, uint256 varg2) private {
    v0 = _allowance[address(varg2)][address(varg1)];
    if (v0 != uint256.max) {
        require(v0 >= varg0, Error('ERC20: insufficient allowance'));
        0x970(v0 - varg0, varg1, varg2);
    }
    return ;
}

function 0xbbe(uint256 varg0, uint256 varg1, uint256 varg2) private {
...
function 0xe33(uint256 varg0, uint256 varg1) private {
...
function __function_selector__(bytes4 function_selector) public payable {
    ...
    if (msg.data.length < 4) {
        ...
        if (0x313ce567 > function_selector >> 224) {
            ...
            require(0x5b19ec68 == function_selector >> 224);
            0x5b19ec68();
        }
